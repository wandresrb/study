...
4. Divide ese `n` entre cuatro o entre seis. Ese es el umbral en el móvil de gama media de tus usuarios, y el factor sale del throttling de CPU calibrado que se trata en el [nivel de móvil](/guia/rendimiento/n35-throttling-de-cpu-y-red/).
