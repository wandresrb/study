...
<Pipeline
  titulo="una herramienta por capa"
  resultado="tres alcances, tres teclados, cero conflictos"
  grupos={[
    { titulo: 'capa 1 · mientras escribes', tono: 'green', secuencia: false, pasos: [
    ...
    { titulo: 'capa 2 · sobre un bloque', tono: 'blue', secuencia: false, pasos: [
    ...
    { titulo: 'capa 3 · sobre el proyecto', tono: 'mauve', secuencia: false, pasos: [
