...
description: "Las opciones de Neovim no son un espacio plano de nombres y valores: cada una tiene un ámbito declarado en el núcleo, y ese ámbito decide si tu asignación afecta a todo el editor, a un buffer o solo a la ventana activa."
subject: neovim
level: 8
order: 2
posicion: "8.2"
