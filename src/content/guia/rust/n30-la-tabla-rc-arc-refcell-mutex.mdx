...
<Mermaid code={`flowchart TD
  ...
  style one1 fill:#fab387,color:#11111b
  style one2 fill:#fab387,color:#11111b
  style many1 fill:#a6e3a1,color:#11111b
  style many2 fill:#a6e3a1,color:#11111b
  style combo fill:#cba6f7,color:#11111b`} />
