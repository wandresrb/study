...
<Mermaid code={`flowchart TD
  graph[project graph inferido] --> affected[nx affected]
  graph --> cache[cache por hash de entradas]
  graph --> gen[generadores y executors]
  graph --> cloud[nx cloud reparto entre agentes]
  style graph fill:#cba6f7,color:#11111b
  style cloud fill:#89b4fa,color:#11111b`} />
