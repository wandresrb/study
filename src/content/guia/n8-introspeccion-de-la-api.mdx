...
description: "Neovim se describe a sí mismo en tiempo de ejecución con un detalle que casi nadie aprovecha: el catálogo completo de opciones con su ámbito y su tipo, la especificación de cada función de la API con su versión de aparición y su estado de obsolescencia, la lista viva de mapeos, autocomandos, comandos y resaltados, y el motor de completado de la línea de comandos convertido en función consultable. Esta lección enseña a interrogar al editor en lugar de memorizarlo, a construir pequeñas herramientas de exploración con vim.print y vim.iter, y a combinar el descubrimiento en tiempo de ejecución con la certeza que solo da la documentación."
subject: neovim
level: 8
order: 5
icon: "8.5"
