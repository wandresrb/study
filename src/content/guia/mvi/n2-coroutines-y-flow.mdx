...
<Mermaid code={`flowchart LR
  ...
  C --> O
  V --> O
  style KT fill:#89b4fa,color:#11111b
  style O fill:#cba6f7,color:#11111b`} />
...
<Mermaid code={`flowchart TD
  ...
  style AND fill:#89b4fa,color:#11111b
  style IOS fill:#f9e2af,color:#11111b`} />
...
<Reto title="Cierra el circulo con las corrutinas">
