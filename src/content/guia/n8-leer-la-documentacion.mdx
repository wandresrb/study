...
description: "La ayuda de Neovim no es un manual de consulta ocasional sino la especificación normativa del editor, escrita por las mismas personas que escriben el código y versionada junto a él. Esta lección enseña a leerla como se lee una especificación: la gramática de las etiquetas, que convierte el nombre de cualquier cosa en la dirección exacta donde está documentada; el mapa de los archivos de referencia y su diferencia con el manual de usuario; las técnicas de búsqueda dentro del editor cuando no se conoce el nombre; y el uso de checkhealth, verbose y messages como instrumentos de diagnóstico ante un comportamiento inexplicado."
subject: neovim
level: 8
order: 4
icon: "8.4"
