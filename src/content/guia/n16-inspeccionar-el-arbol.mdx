...
```lua
-- Abrir el visor para el buffer actual
vim.keymap.set("n", "<leader>ti", function()
  vim.treesitter.inspect_tree({ lang = nil })
end, { desc = "Inspeccionar el arbol" })

-- Abrir el editor de consultas sobre el arbol visible
...
print(ok and parser:lang() or "sin parser para este buffer")
```
...
<Reto title="Leer tu código como árbol">
