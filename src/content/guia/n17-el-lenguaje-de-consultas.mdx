...
; supertipos: cualquier sentencia que ademas sea de expresion
...
Dos iteradores conviven y no son intercambiables. `iter_captures` recorre capturas sueltas en orden de aparición en el búfer: es lo que quiere un resaltador, que solo necesita saber qué color pintar dónde. `iter_matches` devuelve coincidencias completas, con todas las capturas de un mismo patrón agrupadas: es lo que necesitas cuando la relación entre capturas importa, por ejemplo para asociar el nombre de una función con su cuerpo.
...
<Reto title="Traduce tres formas a patrones">
