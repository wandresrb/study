...
<Mermaid code={`flowchart TB
  ...
  style geo fill:#cba6f7,color:#11111b
  style wgl fill:#f9e2af,color:#11111b
  style vbo fill:#94e2d5,color:#11111b
  style ebo fill:#94e2d5,color:#11111b
  style vao fill:#fab387,color:#11111b
  style draw fill:#fab387,color:#11111b
  style vs fill:#a6e3a1,color:#11111b
  style rast fill:#fab387,color:#11111b
  style fs fill:#a6e3a1,color:#11111b
`} />
