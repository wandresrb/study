...
<Callout type="dios" title="Ninguna de estas capacidades justifica robar Ctrl-Espacio">
...
<Instalar repo="stevearc/conform.nvim" nota="Orquesta formateadores externos: encuentra el binario, le pasa el buffer y aplica la salida como ediciones. Si la herramienta falta o falla, no toca el fichero.">
<Fragment slot="lazy">

```lua title="lua/plugins/conform.lua"
return {
