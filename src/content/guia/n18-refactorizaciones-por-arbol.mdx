...
<Instalar repo="nvim-treesitter/nvim-treesitter-textobjects" nota="El intercambio vive en el modulo swap. Si ya instalaste el plugin en una leccion anterior, no lo repitas: basta con anadir las teclas.">
<Fragment slot="lazy">
...
vim.keymap.set("n", "<leader>ca", function() swap.swap_next("@parameter.inner") end,
