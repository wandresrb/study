...
<Instalar repo="nvim-treesitter/nvim-treesitter" nota="main no admite carga perezosa: con lazy.nvim va lazy = false y build = ':TSUpdate'. install es asincrono; para un arranque sincrono encadena :wait(300000).">
<Fragment slot="lazy">
