...
description: "Neovim no ofrece una API sino tres superficies distintas sobre el mismo núcleo, y elegir mal entre ellas es la causa silenciosa de la mitad de las configuraciones frágiles. Esta lección separa vim.api, que es el contrato estable que también hablan los clientes remotos por msgpack-RPC; vim.fn, que es un puente hacia el evaluador de Vimscript con su propio sistema de tipos y sus propias ambigüedades; y vim.cmd, que ejecuta comandos ex con todos sus efectos de usuario. Establece un criterio de elección que no se basa en la velocidad sino en los efectos colaterales, en la estabilidad del contrato y en si la operación describe un cambio de estado o imita a una persona tecleando."
subject: neovim
level: 8
order: 1
icon: "8.1"
