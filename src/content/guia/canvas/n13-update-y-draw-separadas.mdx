...
<Mermaid code={`flowchart TB
  ...
  compositor --> raf
  style raf fill:#89b4fa,color:#11111b
  style dt fill:#cba6f7,color:#11111b
  style entrada fill:#94e2d5,color:#11111b
  style update fill:#a6e3a1,color:#11111b
  style draw fill:#f9e2af,color:#11111b
  style compositor fill:#fab387,color:#11111b`} />
