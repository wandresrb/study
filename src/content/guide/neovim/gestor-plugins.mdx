...
<Pipeline
  title="el falso dilema: los dos acaban en el mismo sitio"
  result="runtimepath — de donde Neovim carga TODO"
  groups={[
    { title: 'vim.pack — el nativo', tone: 'green', steps: [
    ...
    { title: 'lazy.nvim — la carga perezosa', tone: 'mauve', steps: [
...
<Install repo="folke/which-key.nvim" motivo="El caso contrario a Treesitter, y por eso va aquí: no hace falta hasta que pulsas leader, así que VeryLazy lo saca por completo del arranque. Este es un plugin donde lazy.nvim gana de verdad." nota="En la vía nativa no existe VeryLazy, pero se puede imitar con un autocomando (ver abajo).">
<Fragment slot="lazy">
...
<Challenge title="Tu primer setup con plugins">
