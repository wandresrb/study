...
<Install repo="nvim-treesitter/nvim-treesitter" motivo="Solo vim.pack: la rama main no admite carga perezosa. El porque, en la leccion 2.3." nota="main no admite carga perezosa: con lazy.nvim va lazy = false y build = ':TSUpdate'. install es asincrono; para un arranque sincrono encadena :wait(300000).">
<Fragment slot="pack">
...
<Challenge title="Seguir la cadena completa">
