...
<Pipeline
  title="la conversación cliente ↔ servidor"
  result="el editor entiende tu código sin saber nada del lenguaje"
  groups={[
    { title: 'Neovim pregunta', tone: 'blue', steps: [
    ...
    { title: 'el servidor responde (y avisa solo)', tone: 'mauve', steps: [
...
<Install repo="neovim/nvim-lspconfig" nota="Opcional. Solo añade su carpeta lsp/ al runtimepath: no arranca, no activa y no configura nada por su cuenta.">
<Fragment slot="lazy">
...
<Install repo="mason-org/mason.nvim" nota="Opcional. Tiene que cargarse antes de que arranque ningún servidor, porque lo que hace es poner su directorio de binarios en el PATH.">
<Fragment slot="lazy">
...
<Install repo="folke/lazydev.nvim" nota="Completado y tipos correctos para tu propia config de Neovim en Lua. Con esto no necesitas el truco de declarar vim como global en los settings de lua_ls.">
<Fragment slot="lazy">
...
<Challenge title="Enciende el cerebro">
