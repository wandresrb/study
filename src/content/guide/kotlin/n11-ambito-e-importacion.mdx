...
<Mermaid code={`flowchart TB
  inv[llamada texto punto enviar dentro de Conexion] --> d[receptor de despacho igual a la Conexion]
  inv --> e[receptor de extension igual al String]
...
<Challenge title="Domina el ámbito">
